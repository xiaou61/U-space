...
public class OperationLogQueryRequest implements PageRequest {
     ...
     */
    @Override
    public OperationLogQueryRequest setPageNum(Integer pageNum) {
     ...
     */
    @Override
    public OperationLogQueryRequest setPageSize(Integer pageSize) {
