...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Bug条目表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户Bug浏览历史表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `version_history`  (
                                    ...
                                    INDEX `idx_sort_order`(`sort_order` ASC) USING BTREE,
                                    INDEX `idx_created_time`(`created_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '版本更新历史表' ROW_FORMAT = Dynamic;
